...
const corsHeaders = {
  ...
  'Access-Control-Allow-Headers':
    'authorization, x-client-info, apikey, content-type, x-lovable-signature, x-lovable-timestamp, x-supabase-client-platform, x-supabase-client-platform-version, x-supabase-client-runtime, x-supabase-client-runtime-version, accept, origin, boundary',
}
...
// Configuration
const SITE_NAME = "clever-career-catapult"
const SENDER_DOMAIN = "notify.atsproresumebuilder.com"
const ROOT_DOMAIN = "atsproresumebuilder.com"
const FROM_DOMAIN = "atsproresumebuilder.com" // Domain shown in From address (may be root or sender subdomain)
...
const SAMPLE_PROJECT_URL = "https://clever-career-catapult.lovable.app"
